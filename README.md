...
|:---:|:---:|:---:|:---:|:---:|:---:|
|`tower_node_list`|""|yes|list of strings|A list of FQDN or IP addresses|["example.com", "127.0.0.1"]|
|`tower_ah_node`|""|yes|string|FQDN or IP address of Automation Hub node|"127.0.0.2"|
